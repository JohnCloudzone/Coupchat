...
export default function DirectChatPage({ conversation, onBack, onViewProfile, onCall }) {
        ...
        <div className="h-full flex flex-col">
            ...
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-[var(--border)] glass flex-shrink-0">
                ...
                <div className="flex items-center gap-1.5">
                    <button
                        onClick={() => onCall?.({ type: 'audio', isCaller: true, partner: conversation.participantGuestId })}
                    ...
                    <button
                        onClick={() => onCall?.({ type: 'video', isCaller: true, partner: conversation.participantGuestId })}
                        className="p-2 rounded-lg hover:bg-[var(--bg-tertiary)] transition-colors" style={{ color: 'var(--text-secondary)' }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
